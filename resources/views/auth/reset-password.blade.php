...
<body class="flex items-center justify-center h-screen bg-gray-100">
    <div class="login-container bg-white p-6 rounded-lg shadow-lg w-80">
        <h2 class="text-2xl font-bold text-center mb-6">Criar senha nova</h2>
        ...
        <form method="POST" action="{{route('password.update')}}">
            ...
            <div class="mb-4">
                <label for="password_confirmation" class="block text-sm font-medium text-gray-700">Repita a Senha:</label>
                <input type="password" class="form-control mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" id="password_confirmation" name="password_confirmation" required>
            </div>
